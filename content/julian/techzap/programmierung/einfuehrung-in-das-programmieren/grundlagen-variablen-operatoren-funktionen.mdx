---
title: "Grundlagen: Variablen, Operatoren, Funktionen"
description: "Grundlagen: Variablen, Operatoren, Funktionen"
...
formatiere_ueberschrift mit text, schriftgroesse, ausrichtung:
...
Ende von formatiere_ueberschrift

Aufgerufen würde diese Funktion dann mittels:

formatiere_ueberschrift mit "Einführung in die Programmierung", 15 Punkt, links
