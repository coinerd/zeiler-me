...
description: "Geschichte, Philosophie und Gesellschaft – Ein Essay von Detlef Zeiler"
...
- Öffentliche Regeln: Es muss feste Regeln geben, die allen Mitgliedern einer 
 Gemeinschaft bekannt sind ("Öffentlichkeit").
- Gesetzliche Grundlagen: Es muss folgerichtig ein Regelwerk geben, das die 
 Regeln festhält: Das sind Gesetze.
- Überwachung und Kontrolle: Es muss Leute geben, die die Einhaltung der Gesetze 
 überwachen und instinkthaftes Gier-Verhalten (egal aus welchem Motiv) einschränken.
- Neugier als besondere Gier: Sie überschreitet Grenzen, ist vor allem in jüngerem 
 Alter wichtig. Sie muss in Bahnen gelenkt werden, die mit den vorherigen Punkten kompatibel sind.
- Zivilisatorische Zyklen: Da dies nicht immer gelingt, wird es immer wieder 
...
- Kulturelle Färbung: Zivilisationen sind abhängig von mit ihnen verbundenen Kulturen. 
...
- Multikulturelle Gesellschaften: Multikulturelle Gesellschaften haben in der Geschichte 
...
- Demokratische Stabilität: Demokratien mit labilen Machtzentren, mit festgelegten 
...
- Fehlende Mythen: Fehlen diese "Mythen" (quasi ideelle Rückversicherungen), wie etwa 
...
- Globale Umweltkatastrophe: Einen Zwang zum Zusammenführen unterschiedlicher Kulturen 
...
- Rückwärtsgewandter Erlösungsglaube: Der rückwärtsgewandte "ERLÖSUNGSGLAUBEN" durch 
...
- Technokratie ohne Idee: Das, was wir in der westlichen Welt in Teilen der 
...
- Unter die Tiere fallen: Fällt die Idee der Zivilisation aber im Denken und Handeln weg, 
...
•
 Inwiefern unterscheidet sich menschliche Moral von tierischem Verhalten?


•
 Welche Rolle spielen Kultur und Zivilisation bei der Entwicklung menschlicher Ethik?


•
 Warum verwenden wir Tiervergleiche für menschliches Fehlverhalten, obwohl Tiere solches Verhalten nicht zeigen?


•
 Welche "zivilisatorischen Ideen" könnten heute als Gegenentwurf zu Nationalismus und religiösem Fundamentalismus dienen?
